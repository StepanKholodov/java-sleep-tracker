...
/**
 * Подсчитывает количество бессонных ночей в периоде логирования.
 * <p>
 * Бессонной считается ночь, когда ни одна сессия сна не пересекает
 * интервал с 00:00 до 06:00 локального времени указанной даты.
 * <p>
 * Период логирования определяется от начала первой сессии до конца последней.
 * Первая потенциальная ночь определяется по правилу:
 * <ul>
 *   <li>если первая сессия началась до 12:00 — ночь считается предыдущей календарной датой</li>
 *   <li>если после 12:00 — следующей календарной датой</li>
 * </ul>
 */
